...
DATA_DIR = r"file path"  # Folder containing the .bin files
NX, NY, NZ =  1, 1, 1   # Grid size
LX, LY, LZ =  1, 1, 1   # Domain dimensions
...
SINGLE_TIME_STEP =  # eg 5

# 3. Parameters for Time History Analysis
# Used for the TKE vs. Time plot
TIME_STEP_START = 1
TIME_STEP_END = 10  # last time step

# 4. File Naming Parameters
FILE_PREFIX_U = 'ux'    # use your file prefixes
FILE_PREFIX_V = 'uy'
FILE_PREFIX_W = 'uz'
FILE_EXTENSION = '.bin' # File extension
